<template>
  <div class="min-h-screen from-gray-50 to-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <h1 class="text-2xl md:text-3xl font-bold mb-6 dark:text-white flex flex-col md:flex-row md:items-center gap-2">
        <span class="bg-blue-500 dark:text-white px-4 py-1 rounded-full text-lg">wangEditor 5</span>
        <span class="text-base font-normal dark::text-gray-100">开源 Web 富文本编辑器，开箱即用，配置简单</span>
